<template>
  <div id="app">
    ...
    <van-radio-group v-model="scores[1]">
    ...
    <van-radio-group v-model="scores[2]">
    ...
    <van-radio-group v-model="scores[3]">
    ...
    <van-radio-group v-model="scores[4]">
    ...
    <van-radio-group v-model="scores[5]">
    ...
    <van-popup v-model="show" position="bottom">
      <div class="content-info">
        <p class="content-info-title">一、校级及以上级“三好学生”、“优秀学生”、“优秀学生干部”、“优秀毕业生”</p>
        <p>&emsp;经认定的国家级 10分</p>
        <p>&emsp;省（自治区、直辖市）级 5分</p>
        <p>&emsp;学校级（每次1分，不超过2分） 1分</p>
        ...
        <p>&emsp;⑴ 上述全国性比赛奖项：</p>
        <p>&emsp;一等奖 10分 二等奖 8分 三等奖 6分</p>
        <p>&emsp;⑵ 上述全国性比赛地方赛区奖项：</p>
        <p>&emsp;一等奖 5分 二等奖 3分 三等奖 1分</p>
      </div>
    </van-popup>
    ...
    <van-radio-group v-model="scores[7]">
    ...
    <van-radio-group v-model="scores[8]">
    ...
    <van-radio-group v-model="scores[9]">
    ...
    <van-radio-group v-model="scores[10]">
    ...
    <van-radio-group v-model="scores[11]">
    ...
    <van-radio-group v-model="scores[12]">
      <van-radio name="5">在校或休学期间创业，企业经营情况良好 5分</van-radio>
      <van-radio name="0">无 0分</van-radio>
    </van-radio-group>
    <p><a href="http://sh.bendibao.com/zffw/2020925/231117.shtm">重点学科等落户详细信息请点击（可能会清空当前选择）</a></p>
    <van-button :type="total >= 72 ? 'primary' : 'info'" class="score-btn">当前分数: {{total1}}</van-button>
  </div>
</template>
